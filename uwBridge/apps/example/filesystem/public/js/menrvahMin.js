(c=>{'use strict';function d(ke){return function(){var le=Db(E(arguments));return console.log(le),function me(){var ne=E(arguments),oe=[];return ke(le,pe=>{oe[0]=_a(pe,me,oe[0]?oe:ne)}),oe[0]}}}function f(ke,le){return me=>{Qb(0,ke(()=>{},me||1000),ne=>{le(ne)})}}const g=function(ke,le){return Gd(ke,le)};let h;c.$=c.ACID=g,g.super=ke=>{};var j=Array,k=Object,l=Function,m=String,o=JSON,p=Math,q=Boolean,r=void 0,s=WeakMap,t=Map,u=Number,v=RegExp,w=parseInt,x=console.log.bind(console),y='prototype',z=k[y],A=j[y],B=m[y],C=l[y],D=v[y],E=g.toArray=j.from.bind(j),F=g.keys=k.keys,G=g.is=k.is,H=g.assign=k.assign,I=g.getPropDescrip=k.getOwnPropertyDescriptor,J=g.defineProperty=k.defineProperty,K=g.getOwnPropertyNames=k.getOwnPropertyNames,L=!1,M=!0,N=o.stringify,O=o.parse,P=navigator.hardwareConcurrency,Q,R=window,S=document,T=/^.[\w_-]+$/,U=/^[A-Za-z]+$/,V=/\s/,W=/\s/g,X=/\./g,Y=/-/g,Z=/\.|\[/,_=/]/g,aa=/\//g,ba=/_/g,ca=/\.js$/,da=/\.css$/,ea=/\.json$/,fa=/\./,ga=/%(?![\da-f]{2})/gi,ha=/&/g,ia=/</g,ja=/>/g,ka=/"/g,la=/\.|\+/,ma=/\.([0-9a-z]+)/,na=/\//g,oa='.',pa='',qa='/',ra='-',sa='?',ta=' ',ua=location.protocol,va='wss',wa=location.hostname,xa=g.getLength=ke=>{return ke.length},ya=(ke,le)=>{return ke.indexOf(le)},za=g.ensureArray=ke=>{return Bc(ke)?ke:[ke]},Aa=g.ifInvoke=function(){var ke=E(arguments),le=Ua(ke);return Gc(le)?_a(le,ke):r},Ba=g.ifNotEqual=function(ke,le,me){return le?(ke[le]=ke[le]||me,ke[le]):ke},Ca=ke=>{return C.call.bind(ke)},Da=Ca(B.substring),Ea=Ca(B.substr),Fa=Ca(B.slice),Ga=Ca(B.toLowerCase),Ha=Ca(B.toUpperCase),Ia=Ca(B.split),Ja=Ca(B.repeat),Ka=Ca(B.charAt),La=Ca(B.match),Ma=Ca(B.replace),Na=Ca(D.test),Oa=Ca(A.concat),Pa=Ca(A.pop),Qa=Ca(A.push),Ra=g.pushApply=(ke,le)=>{return _a(A.push,ke,le)},Sa=Ca(A.slice),Ta=Ca(A.splice),Ua=Ca(A.shift),Va=Ca(A.unshift),Wa=g.unShiftApply=(ke,le)=>{return _a(A.unshift,ke,le)},Xa=Ca(A.join),Ya=ke=>{return ke.toString()},Za=g.bindTo=Ca(C.bind),$a=g.callFn=(ke,le,me)=>{return me||(me=le,le=ke),ke.call(le,me)},_a=g.applyFn=(ke,le,me)=>{return me||(me=le,le=ke),ke.apply(le,me)},ab=0,bb=[],cb={},db=g.uuid=function(ke){var le=Ua(bb);return xc(le)||(le=ab,cb[le]=M,ab++),le},eb=db.remove=ke=>{cb[ke]=null,Qa(bb,ke)};g.info={host:{protocol:ua,protocolSocket:va,name:wa},hardware:{cores:P}};var fb=g.eventAdd=function(ke,le,me,ne){return ke.addEventListener(le,me,ne),ke},gb=g.eventRemove=function(ke,le,me,ne){return ke.removeEventListener(le,me,ne),ke};g.isEnter=function(ke){var le=ke.keyCode;return!(13!=le)};var hb=g.insertInRange=(ke,le,me,ne)=>{return Fa(ke,0,le)+ne+Fa(ke,me,xa(ke))},ib=g.rightString=function(ke,le){return ke[xa(ke)-1-le]},jb=g.chunkString=(ke,le)=>{return La(ke,new v('(.|[\r\n]){1,'+le+'}','g'))};g.initialString=ke=>{return ke.slice(0,-1)},g.restString=ke=>{return ke.slice(1,xa(ke))},g.replaceWithList=(ke,le,me)=>{return Ma(ke,new v('\\b'+Xa(le,'|')+'\\b','gi'),me)};var kb=g.rawURLDecode=ke=>{return decodeURIComponent(Ma(ke,ga,function(){return'%25'}))},lb=g.htmlEntities=ke=>{return ke=Ma(ke,ha,'&amp;'),ke=Ma(ke,ia,'&lt;'),ke=Ma(ke,ja,'&gt;'),ke=Ma(ke,ka,'&quot;'),Ma(ke,na,'&quot;')},mb=g.sanitize=ke=>{return lb(kb(ke))},nb=g.duc=decodeURIComponent,ob=g.euc=encodeURIComponent;g.tokenize=function(ke){return La(ke,/\S+/g)||[]},g.words=function(ke){return La(ke,/\w+/g)||[]};var pb=ke=>{return Ha(Ka(ke,0))},qb=g.restString=(ke,le)=>{return Ea(ke,le||1)},rb=g.ucFirst=function(ke){return pb(ke)+qb(ke)},sb=g.ucFirstAll=function(ke){return Xa(Tb(Ia(ke,ta),function(le){return rb(le)}),' ')},tb=g.ucFirstOnly=function(ke){return pb(ke)+Ga(qb(ke))},ub=g.ucFirstOnlyAll=function(ke){return Xa(Tb(Ia(ke,ta),function(le){return tb(le)}),' ')},vb=g.camel=ke=>{return ke=sb(Ma(Ma(ke,ba,ta),Y,ta)),Ga(Ka(ke,0))+Ma(Ea(ke,1),W,pa)},wb=(ke,le)=>{return Ma(Ma(Ga(ke),ba,ta),W,le)},xb=g.kebab=ke=>{return wb(ke,ra)},yb=g.snake=ke=>{return wb(ke,ra)},zb=g.truncate=(ke,le)=>{return xa(ke)>le&&(ke=Fa(ke,0,le)),ke},Ab=g.truncateLeft=(ke,le)=>{var me=xa(ke);return me>le&&(ke=Ea(ke,le,me)),ke},Bb=g.truncateWord=(ke,le)=>{return ya(ke,' ',le),-1!=le&&(ke=Da(ke,0,le)),ke},Cb=g.addParam=(ke,le)=>{return ke=xa(ke)&&Hc(ke,sa)?gc(ke)===sa?ke+le:ke+'&'+le:sa+le,ke},Db=g.flatten=(ke,le)=>{for(var me=0;me<(le||1);me++)ke=ke.reduce((ne,oe,pe,qe)=>{return Oa(ne,le?za(oe):Bc(oe)?Db(oe):oe)},[]);return ke},Eb=g.compact=ke=>{return Cd(ke,le=>{return Dc(le)&&!xa(le)?r:le})},Fb=(ke,le,me)=>{var me=me||{};return Sb(le,(ne,oe)=>{ke(ne,oe,me)}),me};g.chunk=(ke,le=1,me=0)=>{return Ob(new j(rd(xa(ke)/le)),(ne,oe)=>{return hc(ke,me,me+=le)})};var Gb=g.clear=function(ke){return ke.length=0,ke},Hb=g.cloneArray=Sa;g.countBy=function(ke,le){var ne,me={};return Sb(ke,oe=>{ne=le(oe),me[ne]||(me[ne]=0),me[ne]++}),me},g.countKey=function(ke,le){var me=0;return Sb(ke,ne=>{ne[le]&&me++}),me},g.countNoKey=function(ke,le){var me=0;return Sb(ke,ne=>{ne[le]||me++}),me};var Ib=g.range=function(ke,le,me=1,ne){if(0===me)return Jb(ke,le);xc(le)||(le=ke,ke=0);var oe=ne?[]:[ke];if(ke>le)for(;ke>le;)ke=ke-me,ke>le&&Qa(oe,ke);else if(ke<le)for(;ke<le;)ke=ke+me,ke<le&&Qa(oe,ke);return ne&&Qa(oe,ke),oe},Jb=(ke,le)=>{le=0>le?-1*le:le;for(var me=[],ne=1;ne<le;)ne++,Qa(me,ke);return me};g.rangeRight=function(ke=0,le,me){return 0===me?Jb(ke,le):(le?0>me&&ke>le&&(me=-1*me):(le=ke,ke=0),Ib(le,ke,me,M))},g.rangeTo=function(ke,le,me){return Ib(ke,le+(me||1),me)},g.difference=function(ke,le){return Ob(ke,me=>{if(!Hc(me,le))return me})};var Kb=g.drop=function(ke,le,me){return Ta(ke,le,me||xa(ke))};g.dropRight=function(ke,le){return Kb(ke,0,xa(ke)-le)};var Lb=ke=>{if(ke){if(ke.halt)return L;if(ke.skip)return ke.skip=!1,M}},Mb=(ke,le)=>{return function(me,ne,oe){return ke(me,function(pe,qe,re,se,te,ue){ue||(ue=te);var ve=_a(ne,ne,arguments);if(ve!==le)return ve;return(ue.halt=M,oe)?ve:void 0},M)}},Nb=ke=>{return function(le,me,ne){var pe,oe=[];return Sb(le,function(qe,re,se,te,ue){pe=me(qe,re,se,te,oe,ue),!xc(pe)||(oe[re]=pe)},ne),oe}},Ob=g.filterArray=function(ke,le,me){var oe,ne=[];return Sb(ke,function(pe,qe,re,se,te){oe=le(pe,qe,re,se,ne,te),!xc(oe)||Qa(ne,oe)},me),ne},Pb=g.mapWhileLength=function(ke,le){for(var me=[],ne=xa(ke),oe=0;ne;)me[oe]=le(ke[oe],oe,ke,ne,me),ne=xa(ke),oe++;return me},Qb=g.times=function(ke,le,me){if(!me)var me=le,le=ke,ke=0;for(var oe,ne=[];ke<le;ke++)oe=me(ke,le,ne),!xc(oe)||Qa(ne,oe);return ne},Rb=g.eachArrayRight=function(ke,le,me){me=me?{}:me;for(var ne,oe=xa(ke),pe=oe-1;0<=pe;pe--){if(ne=Lb(me),ne)continue;else if(ne===L)break;le(ke[pe],pe,ke,oe,me)}},Sb=g.eachArray=function(ke,le,me){me=me?{}:me;for(var ne,oe=xa(ke),pe=0;pe<oe;pe++){if(ne=Lb(me),ne)continue;else if(ne===L)break;le(ke[pe],pe,ke,oe,me)}},Tb=g.mapArray=Nb(Sb),Ub=g.mapArrayRight=Nb(Rb),Vb=g.eachWhileFalse=Mb(Sb,M),Wb=g.eachWhile=Mb(Sb,L),Xb=g.mapWhileFalse=Mb(Tb,M),Yb=g.mapArrayRightWhile=Mb(Ub,L),Zb=g.mapWhile=Mb(Tb,L),$b=g.isEqualArray=(ke,le)=>{var me=M;return xa(le)===xa(ke)?Wb(le,(ne,oe)=>{if(ke[oe]!==ne)return me=L,me}):me=L,me},_b=g.isEqualArrayDeep=(ke,le)=>{var me=M;return xa(le)===xa(ke)?Wb(le,(ne,oe)=>{return me=_c(ne,ke[oe]),me}):me=L,me};g.findDifference=function(ke,le){var ne,oe,pe,me=xa(ke);for(var qe=0;qe<me;qe++)if(ne=ke[qe],oe=le-ne,pe=ke.indexOf(oe),-1!=pe&&pe!=qe){returned.start=ne,returned.end=oe,returned.startIndex=qe,returned.endIndex=pe;break}return{}};var ac=g.find=(ke,le,me)=>{var ne;return Vb(ke,(oe,pe)=>{return ne=le(oe,pe),!!xc(ne)},me),ne},bc=g.findItem=(ke,le,me='id',ne,oe=M)=>{return ac(ke,(pe,qe)=>{if(pe[me]==le)return ne?qe:pe},oe)},cc=g.findIndex=(ke,le,me='id')=>{return bc(ke,le,me,M,M)};g.findSum=function(ke,le){var ne,oe,pe,me=xa(ke);for(var qe=0;qe<me;qe++)if(ne=ke[qe],oe=le-ne,pe=ke.indexOf(oe),-1!=pe&&pe!=qe){returned.start=ne,returned.end=oe,returned.startIndex=qe,returned.endIndex=pe;break}return{}},g.first=function(ke,le){return le?Sa(ke,0,le):ke[0]},g.flow=d(Sb),g.flowRight=d(Rb),g.groupBy=function(ke,le){return Fb=((me,ne,oe)=>{let pe=le(me);oe[pe]||(oe[pe]=[]),Qa(oe[pe],me)},ke)},g.indexBy=function(ke,le){return Fb=((me,ne,oe)=>{oe[me[le]]=me},ke)};var dc=ke=>{return le=>{return le=Hb(le),ke(le),le}},ec=g.initial=dc(Pa),fc=g.rest=dc(Ua);g.intersect=function(){var ke,le=arguments;return Ob(le[0],me=>{if(ke=!0,Sb(le,ne=>{Hc(ne,me)||(ke=!1)}),ke)return me})},g.invoke=function(ke,le,me){return Tb(ke,ne=>{return _a(ne[le],ne,me)})},g.largest=ke=>{return _a(qd,p,ke)};const gc=g.last=function(ke,le){const me=xa(ke);return le?Sa(ke,me-le,me):ke[me-1]};g.numSort=function(ke){return ke.sort(ic)},g.object=function(ke,le){return Fb((me,ne,oe)=>{oe[le[ne]]=me},ke)},g.partition=(ke,le)=>{var me=[];return[Ob(ke,(ne,oe)=>{return le(ne)?ne:Qa(me,ne)}),me]},g.pluck=function(ke,le){if(Bc(le))var me=(ne,oe)=>{return Fb((pe,qe,re)=>{re[pe]=ne[pe]},le)};else var me=(ne,oe)=>{return ne[le]};return Tb(ke,me)},g.rNumSort=function(ke){return ke.sort(jc)},g.remove=function(ke,le){var me=Gc(le);return le=za(le),Sb(ke,(ne,oe)=>{(me?le(ne):Hc(le,ne))&&Ta(ke,oe,1)}),ke},g.right=function(ke,le){return ke[xa(ke)-1-le]},g.sample=function(ke,le){if(le){var me=E(ke);return Zb(me,(ne,oe,pe)=>{return Ta(me,sd(pd()*(pe-1)),1)[0]})}return ke[sd(pd()*xa(ke))]},g.shuffle=function(ke){var le=E(ke);return Pb(le,()=>{return Ta(le,pd(pd()*(xa(le)-1)),1)[0]})},g.smallest=function(ke){return _a(p.min,p,ke)},g.sortAlpha=(ke,le)=>{var me,ne;return ke.sort((oe,pe)=>{return me=oe[le],ne=pe[le],me<ne?-1:me>ne?1:0}),ke},g.sortedIndex=function(ke,le){var me=0;return Sb(ke,(ne,oe)=>{le>ne&&(me=oe)}),0<me&&(me=me+1),me},g.sumOf=function(ke,le=0){return Bd(ke,(me,ne)=>{le=me?le+(Dc(me)?u(me):me):le}),le},g.take=function(ke,le){return Sa(ke,0,le)},g.takeRight=function(ke,le){return Ta(ke,xa(ke)-le,le)},g.union=function(){var ke=[];return Sb(arguments,le=>{Sb(le,me=>{Hc(ke,me)&&Qa(ke,me)})}),ke};var hc=(ke,le,me)=>{return Tb(new j(p.min(me,xa(ke))-le),(ne,oe)=>{return ke[le+oe]})},ic=(ke,le)=>{return ke-le},jc=(ke,le)=>{return le-ke},kc=(ke,le)=>{return Tb(Oa(ke,le),(me,ne,oe)=>{if(!Hc(le,me)&&0>ya(oe,me))return me})},lc=(ke,le,me)=>{return me.indexOf(ke)===le},mc=g.uniq=(ke,le)=>{return le?Tb(ke,(me,ne)=>{if(me!==ke[ne-1])return me}):ke.filter(lc)};g.without=function(ke,le){var me=Gc(le);return le=za(le),Tb(ke,(ne,oe)=>{if(me?le(ne):Hc(le,ne))return ne})},g.xor=function(ke){var me,le=xa(arguments);return le?(me=kc(ke,arguments[0]),Sb(arguments,ne=>{me=kc(me,ne)}),me):mc(ke)},g.zip=function(){var ke=arguments;return Tb(ke[0],function(le){return Tb(ke,me=>{return Ua(me)})})},g.unZip=function(ke){return Tb(ke[0],le=>{return Tb(ke,me=>{return Ua(me)})})};const nc=async function(ke,le){const me=ke.shift();me&&(await me(le),await oc(ke,le))},oc=g.asyncEach=async function(ke,le){await nc([...ke],le)},pc=async function(ke,le){const me=ke.shift();me&&(await le(me),await qc(ke,le))},qc=g.eachAsync=async function(ke,le){await pc([...ke],le)},rc=g.sortNewest=function(ke,le,me){const ne=me?ke:[...ke];return ne.sort((oe,pe)=>{if(!pe[le])return-1;return oe[le]?oe[le]<pe[le]?1:oe[le]>pe[le]?-1:0:1})};g.getNewest=(ke,le)=>{return rc(ke,le)[0]};const sc=g.sortOldest=function(ke,le,me){const ne=me?ke:[...ke];return ne.sort((oe,pe)=>{if(!pe[le])return-1;return oe[le]?oe[le]<pe[le]?1:oe[le]>pe[le]?-1:0:1})};g.getOldest=(ke,le)=>{return sc(ke,le)[0]};var tc=g.assignDeep=(ke,le,me)=>{return Vc(le,(ne,oe)=>{Fc(ne)&&Fc(ke[oe])?tc(ke[oe],ne,me):me&&Bc(ne)&&Bc(ke[oe])?Ra(ke[oe],ne):ke[oe]=ne}),ke};const uc=function(ke){return`[object ${ke}]`},vc=ke=>{return le=>{return!!xc(le)&&Ya(le)===ke}},wc=g.isDecimal=function(ke){return La(Ya(ke),la)},xc=g.hasValue=function(ke){return!yc(ke)&&!zc(ke)},yc=g.isUndefined=function(ke){return ke===void 0},zc=g.isNull=function(ke){return null===ke},Ac=g.isAll=function(){var ke=E(arguments),le=!0,me=Ua(ke);return Sb(ke,(ne,oe,pe,qe,re)=>{le=me(ne),le||(re.halt=M)},M),le},Bc=g.isArray=j.isArray,Cc=g.isConstructor=ke=>{return le=>{return!!xc(le)&&le.constructor===ke}},Dc=g.isString=Cc(m),Ec=g.isNumber=Cc(u),Fc=g.isPlainObject=function(ke){return!!xc(ke)&&'Object('===Fa(Ya(ke.constructor).trim(),9,16)},Gc=g.isFunction=function(ke){return!!xc(ke)&&ke instanceof l},Hc=g.has=(ke,le)=>{return Bc(le)?_a(ke.includes,ke,le):ke.includes(le)},Ic=g.hasLength=function(ke){return!!xa(ke)},Jc=g.isEmpty=function(ke){if(Dc(ke)||Bc(ke))return!Ic(ke);return Fc(ke)?!bd(ke):!xc(ke)},Kc=ke=>{return le=>{return!!xc(le)&&ke.test(le)}},Lc=g.isFileCSS=Kc(da),Mc=g.isFileJSON=Kc(ea),Nc=g.isFileJS=Kc(ca),Oc=g.extension=ke=>{return La(ke,/\.([0-9a-z]+)/)},Pc=g.hasDot=Kc(fa),Qc=g.getModelRootName=function(ke){return Ia(ke,oa)[0]},Rc=g.getModelProperty=function(ke){return gc(Ia(ke,qa))},Sc=g.getModelName=function(ke){return Dd(gc(Ia(ke,qa)).replace(/\.js$/,''),Gd)};g.compactKeys=ke=>{var le=[];return Bd(ke,(me,ne)=>{me&&Qa(le,ne)}),le};var Tc=g.mapObject=(ke,le)=>{var me={};return Vc(ke,function(ne,oe){me[oe]=_a(le,arguments)}),me},Uc=g.filterObject=(ke,le)=>{var ne,me={};return Vc(ke,function(oe,pe){ne=_a(le,arguments),xc(ne)&&(me[pe]=ne)}),me},Vc=g.eachObject=(ke,le)=>{Sb(F(ke),(me,ne,oe,pe)=>{le(ke[me],me,ke,pe)})},Wc=g.forEach=(ke,le,me)=>{return ke.forEach(le,me),ke},Xc=g.mapProperty=(ke,le)=>{var me={};return Sb(K(ke),(ne,oe,pe)=>{me[ne]=le(ke[ne],ne,ke,pe,me)}),me},Yc=g.forIn=(ke,le)=>{var me={};for(var ne in ke)me[ne]=le(ke[ne],ne,ke,me);return me};g.hasKeys=(ke,le)=>{var me=L;return Wb(le,ne=>{return me=xc(ke[ne]),me}),me},g.hasAnyKeys=(ke,le)=>{var me=L;return Vb(le,ne=>{return me=xc(ke[ne]),me}),me},g.invert=(ke,le)=>{return le=le||{},Vc(ke,(me,ne)=>{le[me]=ne}),le};var Zc=g.isPropsEqual=(ke,le,me)=>{var ne=L;return Wb(me||F(ke),oe=>{return ne=_c(ke[oe],le[oe]),ne}),ne};g.matches=ke=>{var le=F(ke);return me=>{return Zc(ke,me,le)}};var $c=g.isPropsEqualDeep=(ke,le)=>{var me=L;return $b(F(ke),F(le))&&Wb(F(ke),ne=>{return me=_c(ke[ne],le[ne]),me}),me},_c=g.isMatch=(ke,le)=>{var me=L;return ke===le&&(me=M),Ya(ke)===Ya(le)&&(Fc(ke)?me=$c(ke,le):Bc(ke)&&(me=_b(ke,le))),me};g.omit=(ke,le)=>{return Uc(ke,(me,ne)=>{if(!Hc(le,ne))return me})};var ad=g.pick=(ke,le,me)=>{return Fb((ne,oe,pe)=>{pe[ne]=le[ne]},ke,me)},bd=g.size=ke=>{return xa(F(ke))};g.stringify=N,g.zipObject=function(ke,le,me){return Fb((ne,oe,pe)=>{pe[ne]=le[oe]},ke,me)},g.unZipObject=function(ke){var le=[],me=[];return Vc(ke,(ne,oe)=>{Qa(le,oe),Qa(me,ne)}),[le,me]},g.ary=function(ke,le,me){return function(){return _a(ke,me||ke,E(arguments).splice(0,le))}},g.bindAll=(ke,le,me)=>{return me?(Bd(ke,(ne,oe)=>{Gc(ne)&&(ke[oe]=Za(ne,le))}),ke):Ad(ke,ne=>{return Gc(ne)?Za(ne,le):ne})};let cd=(ke,le)=>{return Bd(le,(me,ne)=>{ke.methods[ne]=function(){var oe=E(arguments);return Va(oe,ke.value),_a(me,oe),ke.methods}}),ke};g.chain=function(ke){var le=me=>{return le.value=me,le.methods};return H(le,{methods:{},add:me=>{return cd(le,me)},done:()=>{var me=le.value;return le.value=null,me}}),le.add(ke),le},g.curry=function(ke){var le=xa(ke),me=[],ne=function(){return Sb(arguments,oe=>{Qa(me,oe)}),ne};return ne.result=()=>{var oe=_a(ke,ne,me);return me=[],oe},ne},g.curryRight=function(ke){var le=xa(ke),me=[],ne=function(){return Sb(arguments,oe=>{Va(me,oe)}),ne};return ne.result=()=>{var oe=_a(ke,ne,me);return me=[],oe},ne},g.method=ke=>{return le=>{return Dd(Bc(ke)?Xa(ke,oa):ke,le)}},g.negate=ke=>{return function(){return!_a(ke,ke,E(arguments))}},g.nthArg=ke=>{return function(){var le=arguments;return 0>ke&&(ke=le.length- -1*ke),le[ke]}},g.once=ke=>{var le;return function me(){return le||(le=_a(ke,me,arguments)),le}};var dd=g.after=(ke,le)=>{return function me(){if(0>--ke)return _a(le,me,arguments)}},ed=g.before=(ke,le)=>{return function me(){if(0<--ke)return _a(le,me,arguments)}};g.onAfter=(ke,le)=>{return dd(ke-1,le)},g.onBefore=(ke,le)=>{return ed(ke+1,le)},g.reArg=(ke,le)=>{return function me(){var ne=arguments;return _a(ke,me,Tb(le,function(oe,pe){return ne[oe]}))}},g.inSync=function(ke,le){return le=za(le),Tb(za(ke),me=>{_a(me,le)})};var fd=Promise.resolve(),gd=fd.then.bind(fd),hd=clearTimeout,jd=g.timer=function(ke,le){return setTimeout(ke,le)},kd=g.interval=function(ke,le){return setInterval(ke,le)};g.debounce=(ke,le)=>{var me=L,ne=function(){me!=L&&hd(me);var oe=E(arguments);me=jd(function(){_a(ke,ne,oe),me=L},le)};return ne.clear=function(){me&&(clearTimeout(me),me=L)},ne},g.throttle=function(ke,le){var ne,me=L,oe=function(){if(me)return void(ne=M);var pe=E(arguments);_a(ke,oe,pe),me=jd(function(){ne&&_a(ke,oe,pe),me=L},le)};return oe.clear=()=>{hd(me),me=L},oe},g.clearTimers=f(jd,hd),g.clearIntervals=f(kd,clearInterval),g.inAsync=function(ke,le){le=za(le),Sb(za(ke),me=>{gd(()=>{_a(me,le)})})};var ld=(ke,le)=>{return function(){function me(){var oe=E(arguments);return Tb(ne,pe=>{return _a(pe,me,oe)})}var ne=[];return H(me,{list:ne,add:function(){var oe=Db(E(arguments));ke(ne,le?oe.reverse():oe)}}),me.add(E(arguments)),me}},md=g.wrap=ld(Ra),nd=g.wrapBefore=ld(Wa,!0);g.isZero=function(ke){return 0===ke},g.isNumberEqual=function(ke,le){return ke===le},g.isNumberInRange=function(ke,le,me){return yc(me)&&(me=le,le=0),ke>le&&ke<me};var od=p.floor,pd=p.random,qd=p.max,rd=p.ceil,sd=p.round;g.math=p,g.add=function(ke,le){return ke+le},g.minus=function(ke,le){return ke-le},g.divide=function(ke,le){return ke/le},g.multiply=function(ke,le){return ke*le},g.remainder=function(ke,le){return ke%le},g.increment=function(ke){return ke+1},g.deduct=function(ke){return ke-1},g.randomArbitrary=function(ke,le){return le=le||0,pd()*(ke-le)+le},g.randomInt=function(ke,le){return le=le||0,od(pd()*(ke-le))+le};var td=g.appState={screenHeight:screen.height,screenWidth:screen.width},ud=g.cnsl=(ke,le)=>{ke=Dc(ke)?ke:N(ke),_a(x,['%c'+ke,`${wd[le]}font-size:13px;padding:2px 5px;border-radius:2px;`])},vd=(ke,le)=>{return`color:${ke};background:${le};`},wd={notify:vd('#fff','#651FFF'),warning:vd('#000','#FFEA00'),important:vd('#fff','#E91E63'),alert:vd('#fff','#f44336')},xd=g.addConsoleTheme=(ke,le,me)=>{wd[ke]=vd(le,me)},yd=g.contract=(ke,le,me)=>{me?yd[le]=ne=>{return Hc(ke,ne)&&Ua(ke)&&!xa(ke)&&gd(me)}:yd[le](ke)},zd=(ke,le)=>{return(me,ne,oe,pe)=>{var qe;if(xc(me))return Bc(me)?qe=ke:Fc(me)||Gc(me)?qe=le:je(me)||ie(me)?(me=E(me),qe=ke):qe=pe?Xc:me.forEach?Wc:le,qe(me,ne,oe)}},Ad=g.map=zd(Tb,Tc),Bd=g.each=zd(Sb,Vc),Cd=g.filter=zd(Ob,Uc),Dd=g.get=(ke,le)=>{return le=le||g,Wb(Ia(gc(Ia(ke,qa)),oa),me=>{return le=le[me],!!xc(le)}),le},Ed=(ke,le)=>{try{var me=new l('"use strict";'+ke).bind(le||me);return me}catch(ne){return L}};g.newFunction=(ke,le)=>{return Ed(ke+'return this;',le||{})},g.iJson=ke=>{return Ed('return '+ke)()};var Fd=g.jsonParse=ke=>{try{return O(ke)}catch(le){return L}};const Gd=g.model=(ke,le)=>{return xc(le)&&(Gd[ke]=le),Dd(ke,Gd)};var Hd=g.promise=ke=>{return new Promise(ke)};g.toggle=function(ke,le,me){return ke===le?me:le};var Id=ke=>{let le=ke.target,me=le.responseText;ke.data='application/json'===le.getResponseHeader('content-type')?Fd(me):me},Jd='application/',Kd=g.xhr=ke=>{let{url:le,data:me,contentType:ne,progress:oe}=ke,pe=new XMLHttpRequest,qe=ke.json,re=ke.type||'GET',se=pa;return ne=ne?ne:qe?`${Jd}json; charset=utf-8`:'GET'==re?'text/plain':`${Jd}x-www-form-urlencoded`,me&&Bd(me,(te,ue)=>{se=xc(te)?Cb(se,Dc(ue)?ue+'='+te:te):se}),'GET'===re&&se&&(le=Cb(le,se),se=pa),qe&&(se=qe),pe.open(re,le,M),pe.setRequestHeader('Content-type',ne),Hd(function(te,ue){fb(pe,'error',ue),fb(pe,'abort',ue),oe&&fb(pe,'progress',oe),fb(pe,'load',ve=>{Id(ve),te(ve)}),pe.send(se)})};g.matchesProperty=(ke,le)=>{return function(me){return Dd(ke,me)===le}},g.overEvery=function(ke){return function(){var le,me=arguments;return Wb(ke,ne=>{return _a(ne,me)}),!!le}},g.over=function(ke){return function(){var le=arguments;return Tb(ke,me=>{return _a(me,le)})}},g.stubObject=()=>{return{}},g.stubArray=()=>{return[]},g.stubString=()=>{return''},g.stubFalse=()=>{return L},g.stubTrue=()=>{return M},g.noop=()=>{return r},g.toPath=ke=>{return ke.replace(_,pa).split(Z)};var Ld=g.getClass=Za(S.getElementsByClassName,S),Md=g.getTag=Za(S.getElementsByTagName,S),Nd=g.getId=Za(S.getElementById,S),Od=g.querySelector=Za(S.querySelector,S),Pd=g.querySelectorAll=Za(S.querySelectorAll,S);g.selector=ke=>{var le=ke[0];switch(le){case'#':if(!Na(V,ke))return Nd(Fa(ke,1));break;case oa:if(Na(T,ke))return Ld(Fa(ke,1));break;default:if(Na(U,ke))return Md(ke);}return Pd(ke)};var Qd=g.isAgent=ke=>{return ke?Qd[ke]:F(Qd)};Sb(Ia(Ma(Ma(Ga(navigator.userAgent),/_/g,oa),/[#_\,\;\(\)]/g,''),/ |\//),ke=>{Qd[ke]=M});var Rd=g.raf=requestAnimationFrame.bind(R),Sd=g.caf=cancelAnimationFrame.bind(R),Td=function(ke,le){return ke.appendChild(le),ke},Ud=L,Vd=[],Wd=()=>{Sb(Vd,Aa),Gb(Vd),Ud=L},Xd=g.batch=ke=>{Ra(Vd,za(ke)),Ud||(Ud=Rd(Wd))};g.isDom=ke=>{return!!ke&&9!=ke.nodeType};var Yd=ke=>{return ke.classList},Zd=(ke,le,me)=>{var ne=Yd(ke);return me=ne.add||me,le?_a(me,ne,za(le)):ne};g.define=(ke,le)=>{ke=setupModelData(ke,le);var me=function(){var ne=Tb(ke.import,orderArgumentObjects);return xa(arguments)&&Ra(ne,arguments),_a(ke.invoke,me,ne)};return setUpModel(me,ke)};var $d=g.domListToArray=ke=>{return Tb(ke,le=>{return ie(le)||je(le)?$d(le):le})};g.exec=Za(S.execCommand,S),g.createFragment=Za(S.createDocumentFragment,S);var _d,ae=function(ke,le,me){var ne;if(Dc(le)){if(xc(me))ke.setAttribute(le,me);else return ke.getAttribute(le);}else if(Fc(le)&&(ne=Tc(le,(oe,pe)=>{return ae(ke,pe,oe)}),me))return ne;return ke},be=g.createTag=Za(S.createElement,S),ce=(ke,le)=>{const me=pe=>{le.accept(pe),oe()},ne=pe=>{le.reject(pe),oe()},oe=()=>{gb(gb(ke,'error',ne,M),'load',me,M)};fb(fb(ke,'error',ne,M),'load',me,M),Td(_d,ke)},de=g.importcss=ke=>{return Hd((le,me)=>{ce(ae(be('link'),{type:'text/css',rel:'stylesheet',href:`${ke}.css`}),{accept:le,reject:me})})},ee=g.importjs=ke=>{return Hd((le,me)=>{let ne=ke;ne.includes('//')||(ne=`${h}${ne}`),'/'===gc(ne)&&(ne=`${ne}index`),ce(ae(be('script'),{async:pa,src:`${ne}.js`,accept:le,reject:me}),{accept:le,reject:me})})};g.toDOM=ke=>{var le=be('div');return le.innerHTML=ke,le};const fe=g.isDocumentReady=ke=>{const le=S.readyState;return'interactive'===le||'completed'===le||'complete'===le?!ke||ke():(ke&&fb(S,'DOMContentLoaded',ke),L)};fe(()=>{_d=Od('head')});var ge=g.updateDimensions=()=>{H(td,{windowHeight:c.innerHeight,windowWidth:c.innerWidth,bodyWidth:Q.offsetWidth,bodyHeight:Q.offsetHeight})};fe(()=>{Q=S.body,Rd(ge)}),fb(fb(window,'resize',ge,M),'load',ge,M);var he=be('a');g.linkParse=function(ke){he.href=ke;var le=Ia(he.hostname,oa),me=he.pathname,ne=xa(le);return le=le[ne-2]+oa+le[ne-1],ad(he,['href','protocol','hostname','port','search','hash','host'],{path:me[0]===qa?me:qa+me,pathroot:me[0]===qa?Ia(me,qa)[1]:Ia(me,qa)[0],ssl:'http:'!==ke.protocol,domain:le})},g.isDocumentReady(()=>{const ke=Nd('acidjs');h=ae(ke,'data-model'),h&&ee('core')}),Sb(['RegExp','Arguments','Boolean','Date','Error','Map','Object','Set','WeakMap','ArrayBuffer','Float32Array','Float64Array','Int8Array','Int16Array','Int32Array','Uint8Array','Uint8ClampedArray','Uint16Array','Uint32Array','HTMLCollection','NodeList'],ke=>{g[`is${ke}`]=vc(uc(ke))});const ie=g.isHTMLCollection,je=g.isNodeList})(this);

/*
	Ractive.js v0.9.0-edge
	Build: unknown
	Date: Sun Mar 19 2017 17:01:52 GMT-0400 (EDT)
...
//Tooltips
!function(e,t){e.RactiveTooltip=t()}(this,function(){return function(e){function t(r){if(n[r])return n[r].exports;var o=n[r]={exports:{},id:r,loaded:!1};return e[r].call(o.exports,o,o.exports,t),o.loaded=!0,o.exports}var n={};return t.m=e,t.c=n,t.p="",t(0)}([function(e,t,n){function r(e,t,n){var r={x:e.pageX,y:e.pageY},o=r.y-n.offsetHeight-5,a=r.x+n.offsetWidth-i.innerWidth,s=e.pageY-n.offsetHeight-5,f=e.pageX-5;a>0&&(f-=a-5),0>o&&(s+=2*n.offsetHeight-5),n.style.transform=`translate3d(${f}px, ${s}px,0)`}function o(e,t){var n,o,i;o={mouseenter:function(o){t&&0!==t.length&&(n||(n=a.createElement("div"),n.className="ractive-tooltip",n.textContent=t),r(o,e,n),a.body.appendChild(n))},mousemove:function(t){n&&r(t,e,n)},mouseleave:function(){n&&n.parentNode&&n.parentNode.removeChild(n)}};for(i in o)o.hasOwnProperty(i)&&e.addEventListener(i,o[i],!1);return{update:function(e){t=e,n&&(n.textContent=t),t&&0!==t.length||!n||!n.parentNode||n.parentNode.removeChild(n)},teardown:function(){n&&n.parentNode&&(n.parentNode.removeChild(n),n=null);for(i in o)o.hasOwnProperty(i)&&e.removeEventListener(i,o[i],!1)}}}n(1);var i=window,a=i.document;e.exports=o},function(e,t,n){var r=n(2);"string"==typeof r&&(r=[[e.id,r,""]]);n(4)(r,{});r.placeholders&&(e.exports=r.placeholders)},function(e,t,n){t=e.exports=n(3)(),t.push([e.id,".ractive-tooltip{position:absolute;display:table;padding:.5em;color:#fff;background:#000;box-shadow:0 2px 2px rgba(0,0,0,.1);border-radius:5px;white-space:nowrap;z-index:99999;font-style:normal;text-transform:none;pointer-events:none}",""])},function(e,t){e.exports=function(){var e=[];return e.toString=function(){for(var e=[],t=0;t<this.length;t++){var n=this[t];n[2]?e.push("@media "+n[2]+"{"+n[1]+"}"):e.push(n[1])}return e.join("")},e.i=function(t,n){"string"==typeof t&&(t=[[null,t,""]]);for(var r={},o=0;o<this.length;o++){var i=this[o][0];"number"==typeof i&&(r[i]=!0)}for(var o=0;o<t.length;o++){var a=t[o];"number"==typeof a[0]&&r[a[0]]||(n&&!a[2]?a[2]=n:n&&(a[2]="("+a[2]+") and ("+n+")"),e.push(a))}},e}},function(e,t,n){function r(e,t){for(var n=0;n<e.length;n++){var r=e[n],o=d[r.id];if(o){o.refs++;for(var i=0;i<o.parts.length;i++)o.parts[i](r.parts[i]);for(;i<r.parts.length;i++)o.parts.push(s(r.parts[i],t))}else{for(var a=[],i=0;i<r.parts.length;i++)a.push(s(r.parts[i],t));d[r.id]={id:r.id,refs:1,parts:a}}}}function o(e){for(var t=[],n={},r=0;r<e.length;r++){var o=e[r],i=o[0],a=o[1],s=o[2],f=o[3],p={css:a,media:s,sourceMap:f};n[i]?n[i].parts.push(p):t.push(n[i]={id:i,parts:[p]})}return t}function i(){var e=document.createElement("style"),t=h();return e.type="text/css",t.appendChild(e),e}function a(){var e=document.createElement("link"),t=h();return e.rel="stylesheet",t.appendChild(e),e}function s(e,t){var n,r,o;if(t.singleton){var s=m++;n=v||(v=i()),r=f.bind(null,n,s,!1),o=f.bind(null,n,s,!0)}else e.sourceMap&&"function"==typeof URL&&"function"==typeof URL.createObjectURL&&"function"==typeof URL.revokeObjectURL&&"function"==typeof Blob&&"function"==typeof btoa?(n=a(),r=u.bind(null,n),o=function(){n.parentNode.removeChild(n),n.href&&URL.revokeObjectURL(n.href)}):(n=i(),r=p.bind(null,n),o=function(){n.parentNode.removeChild(n)});return r(e),function(t){if(t){if(t.css===e.css&&t.media===e.media&&t.sourceMap===e.sourceMap)return;r(e=t)}else o()}}function f(e,t,n,r){var o=n?"":r.css;if(e.styleSheet)e.styleSheet.cssText=g(t,o);else{var i=document.createTextNode(o),a=e.childNodes;a[t]&&e.removeChild(a[t]),a.length?e.insertBefore(i,a[t]):e.appendChild(i)}}function p(e,t){var n=t.css,r=t.media;t.sourceMap;if(r&&e.setAttribute("media",r),e.styleSheet)e.styleSheet.cssText=n;else{for(;e.firstChild;)e.removeChild(e.firstChild);e.appendChild(document.createTextNode(n))}}function u(e,t){var n=t.css,r=(t.media,t.sourceMap);r&&(n+="\n/*# sourceMappingURL=data:application/json;base64,"+btoa(JSON.stringify(r))+" */");var o=new Blob([n],{type:"text/css"}),i=e.href;e.href=URL.createObjectURL(o),i&&URL.revokeObjectURL(i)}var d={},c=function(e){var t;return function(){return"undefined"==typeof t&&(t=e.apply(this,arguments)),t}},l=c(function(){return/msie [6-9]\b/.test(window.navigator.userAgent.toLowerCase())}),h=c(function(){return document.head||document.getElementsByTagName("head")[0]}),v=null,m=0;e.exports=function(e,t){t=t||{},"undefined"==typeof t.singleton&&(t.singleton=l());var n=o(e);return r(n,t),function(e){for(var i=[],a=0;a<n.length;a++){var s=n[a],f=d[s.id];f.refs--,i.push(f)}if(e){var p=o(e);r(p,t)}for(var a=0;a<i.length;a++){var f=i[a];if(0===f.refs){for(var u=0;u<f.parts.length;u++)f.parts[u]();delete d[f.id]}}}};var g=function(){var e=[];return function(t,n){return e[t]=n,e.filter(Boolean).join("\n")}}()}])});

$.menrvah=async function(){const{module:a,ensure:b,map:c,createTag:d,fragment:e,model:f,has:g,pushApply:h,cache:i,last:j,get:k,toArray:l,stringify:m,isString:n,isNumber:o,querySelector:p,isArray:q,isFileCSS:r,isFileJS:s,isFileJSON:t,hasDot:u,getModelProperty:v,getModelRootName:w,hasValue:x,parse:y,camelCase:z,iJson:A,mapWhileFalse:B,mapWhile:C,mapArray:D,mapObject:E,eachWhile:F,each:G,filter:H,cnsl:I,promise:J,inAsync:K,hasAnyKeys:L,define:M,isPlainObject:N,flatten:O,truncate:P,assign:Q,ifInvoke:R,object:S,uuid:T,isEmpty:U,batch:V,ensureArray:W,drop:X,first:Y,initial:Z}=$;I('Spiral initialized','notify'),I('Menrvah Module','notify');const _=$.api={},aa={async setupCompleted(Ra){I('Worker is Ready','notify'),$.systemLanguage=Ra.language;try{await ya('menrvah/'),await ya('app/')}catch(Sa){console.log(Sa),localStorage.clear(),window.location.reload()}}},ba=new Worker('/js/menrvahWorker.js');_.request=apiRequest=async function(Ra,Sa){let Ta;Ta=Sa?{request:Ra,data:Sa}:Ra;const Ua={request:Ta.request,data:Ta.data};return Ua.data.id?ba.postMessage(Ua):J(Va=>{const Wa=Ta.callback,Xa=T();aa[Xa]=Wa?function(Ya){Va(Ya),Wa(Ya)}:Va,Ua.id=Xa,ba.postMessage(Ua)})},ba.onmessage=function(Ra){const Sa=Ra.data,{id:Ta,data:Ua}=Sa;let Va=Ta;x(Va)||(Va='_'),aa[Va](Ua),Sa.keep||'_'===Va||(aa[Va]=null,T.remove(Va))},_.callbacks=aa,$.globalEvents={};const ca=f.core,da=$.socket={},ea=$.loadedAssets={},fa=localStorage,ga=p('head'),ha=d('style'),ia=',',ja='/',ka=new RegExp(/^js\/lib\//),la=Ra=>{return fa[`cs-${Ra}`]},ma=(Ra,Sa)=>{const Ta=ha.cloneNode(!1);return Ta.textContent=Ra,Ta.setAttribute('data-src',Sa),ga.appendChild(Ta),Ta},na=function(Ra){return ea[Ra]},oa=async function(Ra){const{callback:Sa,data:Ta}=Ra,Ua=c(Ta,na);Sa.apply(Sa,Ua)},pa=function(Ra){Ra.done||Ra.filesLoaded!==Ra.fileCount||(Ra.done=!0,oa(Ra))},qa=function(Ra,Sa){const{file:Ta,cs:Ua,key:Va,isJs:Wa,isJson:Xa,isCss:Ya,modelName:Za}=Ra,{appendCSS:$a,data:_a}=Sa,ab=_a[Va];let cb,bb=Ta;if(!0===bb?!ea[ab]&&(bb=fa[ab]):(fa[`cs-${ab}`]=Ua,fa[ab]=bb),!x(ea[ab])||!0!==bb)if(!Wa)ea[ab]=!1===bb?{}:Xa?A(bb||{}):bb;else if(bb)if(ka.test(ab))new Function(bb)(),ea[ab]=top[Za]||f[Za];else{const db=Z(ab.split(ja)).join(ja);if(ea[ab])return Sa.filesLoaded++,void pa(Sa);const eb={_:{name:ab,dirname:`${db}/`}};cb=!0,async function(){await new Function('exports',`var {demand,component,app,request,pipe,push,notify,cnsl}=$; return ${bb}`)(eb),Sa.filesLoaded++,pa(Sa)}(),ea[ab]=eb}return(Ya&&$a&&n(ea[ab])&&(ma(ea[ab],ab),ea[ab]=!0),!cb)?(Sa.filesLoaded++,pa(Sa)):void 0},ra=$.fetchAsset=async function(Ra){const Sa=Ra.data;Ra.filesLoaded=0,Ra.fileCount=Ra.data.length,await apiRequest({request:'socket.get',data:{data:{files:Sa,cs:c(Sa,la)}},callback(Ta){x(Ta.file)?qa(Ta,Ra):pa(Ra)}})},sa=$.request=async function(Ra,Sa){let Ta;Ta=Sa?{request:Ra,data:Sa}:Ra;const Ua={request:'socket.request',data:{name:'api',data:Ta}};if(Ta.id)return Ua.data.data.id=Ua.data.id=Ta.id,void(await apiRequest(Ua));const Va=await apiRequest(Ua);return Ta.callback&&Ta.callback(Va),Va},ta=Ra=>{let Sa=Ra;return u(Sa)||(g(Sa,'language/')?Sa=Fa(Sa):'/'===j(Sa)&&(Sa+='index.js')),Sa},ua=function(Ra){return Ra[0]},va=function(Ra,Sa){return c(Sa,Ta=>{return Ra[Ta]})},wa=function(Ra){return Ra},xa=async function(Ra,Sa){return J(Ta=>{ra(Q({data:Ra,callback(...Ua){Ta(Ua)}},Sa))})},ya=$.demand=async function(Ra,Sa){const Ta=[];let Ua,Va,Wa=Ra;if(!N(Wa))Wa=n(Wa)?Wa.split(ia):Wa,Ua=2>Wa.length?ua:wa,G(Wa,Ya=>{Ta.push(ta(Ya))});else{Ua=va,Va={};let Ya=0;G(Wa,(Za,$a)=>{Va[$a]=Ya,Ya++,Ta.push(ta(Za))})}const Xa=await xa(Ta,Sa);return Ua(Xa,Va)},za=function(Ra,Sa){return function(Ta,Ua){let Va=Ta;return n(Va)&&(Va=Va.split(ia)),Sa&&Sa(Ua),Va=c(Va,Wa=>{let Xa=Wa;return'js'===Ra&&'/'===j(Xa)&&(Xa+='index'),`${Xa}.${Ra}`}),ya(Va,Ua)}},Aa=$.demandCss=za('css',Ra=>{return{appendCSS:Ra}}),Ba=$.demandJs=za('js'),Ca=$.demandHtml=za('html'),Da=$.demandLang=function(Ra){const Sa=n(Ra)?Ra.split(ia):Ra;return ya(c(Sa,Fa))};$.x=function(Ra){return Ra()},$.isEventNode=Ra=>{return Ra&&Ra.original&&Ra.original.target&&Ra.node===Ra.original.target};const Ea=new RegExp(/^language\//),Fa=$.language=function(Ra){let Sa=Ra;return Ea.test(Sa)||('/'!==Y(Sa)&&(Sa=`/${Sa}`),Sa=`language${Sa}`),Sa='/'===j(Sa)?`${Sa}${$.systemLanguage}.json`:`${Sa}/${$.systemLanguage}.json`,Sa};$.super((Ra,Sa)=>{return(Sa&&Sa.invoke?L(Sa,socketImportProperties)?proxyModule:proxyDefine:f)(Ra,Sa)}),I('Pipes setup','notify');const Ga={},Ha=[],Ia=async function(Ra){if(Ja.status){const Sa=Ra.type,Ta=[],Ua=Ga[Sa],Va=H(Ha,Wa=>{if(Wa.regex.test(Sa))return Wa});U(Va)||Ta.push(...Va),Ua&&Ta.push(...Ua),console.log(Ta),Ta.length&&G(Ta,Wa=>{Wa.call(Wa,Ra)})}},Ja=$.pipe=()=>{},Ka=Ja.start=()=>{Ja.status=!0},La=Ja.stop=()=>{Ja.status=null},Ma=(Ra,Sa)=>{const Ta=[],Ua=Sa.prefix?`${Sa.prefix}.`:'',Va=Sa.suffix?`.${Sa.suffix}`:'',Wa={stop(){G(Ta,Xa=>{Xa.stop()})},start(){G(Ta,Xa=>{Xa.start()})},pipes:Ta,_:{isPipe:!0}};return G(Ra,(Xa,Ya)=>{Ta.push(Pa(`${Ua}${Ya}${Va}`,Xa,Sa))}),Wa},Na=(Ra,Sa,Ta)=>{const Ua={},Va=Sa.bind(Ta||Ua);Va.regex=Ra;let Wa=Ha.push(Va)-1;return Q(Ua,{stop(){x(Wa)&&(X(Ha,Wa),Wa=null)},start(){x(Wa)||(Wa=Ha.push(Va)-1)},stream:Va,_:{isPipe:!0}}),Ua},Oa=(Ra,Sa,Ta)=>{const Ua={},Va=async function(...Ya){Ta&&Ta.security&&(await Ta.security())||Sa.call(Ta||Ua,...Ya)};Ga[Ra]||(Ga[Ra]=[]);const Wa=Ga[Ra];let Xa=Wa.push(Va)-1;return Q(Ua,{stop(){x(Xa)&&(X(Wa,Xa),Xa=null)},start(){x(Xa)||(Xa=Wa.push(Va)-1)},stream:Va,_:{isPipe:!0}}),Ua},Pa=Ja.on=(Ra,Sa,Ta)=>(n(Ra)?Oa:N(Ra)?Ma:Na)(Ra,Sa,Ta),Qa=$.push=(Ra,Sa)=>sa({id:'_',request:Ra,data:Sa});Ja.watchers=Ga,Ja.status=!0,_.callbacks._=async function(Ra){Ia(Ra.data)},$.pipeUpdates=Ga,_.request({request:'configure',data:$.config})};