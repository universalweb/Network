...
/*
	...
	In the next block the awards are finalized by creating transactions from the system wallet.
	___________
	TX Fee must be more than minimum of Reserve + Recycle Fee + Minimum TX Fee set by network
	__________
	Take total amount of TX fee
...
function distributeReward(totalReward, recipients, decreaseFactor = null) {
