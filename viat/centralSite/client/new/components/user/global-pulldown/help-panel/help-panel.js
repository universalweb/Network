...
export class HelpPanel extends Panel {
	...
	constructor(state, config) {
		super(state, config);
		if (Object.prototype.hasOwnProperty.call(this, 'shortcuts')) {
			const queued = this.shortcuts;
			Object.defineProperty(this, 'shortcuts', Object.getOwnPropertyDescriptor(HelpPanel.prototype, 'shortcuts'));
			this.shortcuts = queued;
		}
	}
	set shortcuts(list) {
