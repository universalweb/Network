function t(t) {
	...
	Jt as AppLogger, Dn as CONTENT_KIND, Ji as ClassList, Zt as ComponentLogger, fs as DelegateEntry, ea as FRAME_TYPE, Tt as IS_PRODUCTION, Qt as Logger, Yl as SNAP_CURVE, Xl as SNAP_MS, An as Store, na as UniversalWebSocket, oc as WebComponent, Rr as addInterval, lt as allChildren, pt as appendTo, T as assign, K as assignPromisePair, Cn as assignState, ie as atPhase, Cs as behaviorAttrNames, qn as bind, W as cachedProxy, N as callFn, xe as canonicalizeCombo, Zi as classList, kr as clearIntervals, Cr as clearTimeouts, G as clearUnsubs, go as comp, ta as computeAnchor, ec as createDragSnap, sc as createDragTrack, k as createElementFromHTML, wo as each, P as eachArray, O as eachNodeList, A as eachObject, ms as emitDelegate, To as filter, dt as findComponent, _ as fireResolver, s as flipMorph, Ts as getBehavior, at as getComponent, ft as getComponentRoot, ut as getComponents, ht as getComponentsArray, V as getOrInit, R as getProto, Fs as getRef, ir as getRoots, B as getValueAtPath, On as globalState, x as hasOwn, v as hasValue, fo as html, gt as ifAssign, Ro as ifThen, w as isArray, xs as isBehaviorAttr, h as isElement, M as isEmpty, p as isError, a as isFunction, y as isNull, o as isObject, l as isPlainObject, f as isPromiseLike, d as isShadowRoot, c as isString, u as isSymbol, g as isTypeUndefined, m as isUndefined, U as joinPath, C as keysOf, So as list, ct as liveChildren, js as makeRefsProxy, Jc as movingIndicator, Ze as nextFrame, b as noValue, j as parsePath, $ as pathsOverlap, D as plainEqual, mt as prependTo, I as queueAsyncError, Ss as registerBehavior, ot as registerChild, Be as registerHotkey, $s as registerRef, sr as registerRoot, ne as registry, Co as remoteList, xr as removeComponentTimeout, lr as resolveTag, or as resolveTagUrl, L as resolveTarget, q as runHook, cr as scanAndResolve, tn as schedule, Tr as setComponentTimeout, Hc as setDocumentTitle, ic as setInert, Q as setValueAtPath, Z as smartClone, Mr as stopInterval, no as styles, qc as syncDocumentTitle, Y as syncSubsByDiff,
};
