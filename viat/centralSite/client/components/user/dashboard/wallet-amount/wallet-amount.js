	...
	render() {
		...
		this.html `
			<section class="wallet-hero">
				...
				<div class="wa-amount-main">${() => this.globalState.walletAmount?.amount ?? '0'}</div>
				<div class="wa-coin-info">
					<div class="wa-coin-symbol">⩝</div>
					<div class="wa-amount-full">${() => this.globalState.walletAmount?.amountFull ?? '0.000000000'} VIAT</div>
				</div>
			</section>
		`;
	}
