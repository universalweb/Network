...
class AppView extends WebComponent {
	...
	onConnect() {
		...
		const { refs } = this;
		refs.centerBar.updateState({
			...CENTER_BAR,
		});
		refs.globalTopBar.updateState({
			...TOP_BAR,
		});
		refs.globalDock.updateState({
			activeLabel: 'wallet',
		...
		refs.globalBottomBar.updateState({
	...
	setWalletAddress(walletAddress) {
		...
		this.refs.walletPanel.updateState({
			walletAddress,
		});
	}
