...
// GET LAST 32 BYTE PATH CONVERT TO ENCODING
// RETURN FULL PATH
export function getFolderPath(walletAddressBuffer, size = 3, endIndex) {
	const firstFolder = toBase64Url(walletAddressBuffer.slice(0, size));
	const secondFolder = toBase64Url(walletAddressBuffer.slice(size, endIndex));
