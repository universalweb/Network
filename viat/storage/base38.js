...
// import { encodeBase38 } from './base38_simd.js';
// import runBench from '#utilities/benchmark';
// import viatCipherSuite from '#crypto/cipherSuite/viat.js';
// const base38Encode = base38.encodeBase38;
// const hash = await viatCipherSuite.createBlockNonce(64);
// console.log(base38);
// const jsEncode = base38.pure.encodeBase38;
// const nativeEncode = base38.encodeBase38;
// const nativeBase38 = nativeEncode(hash);
// const jsBase38 = jsEncode(hash);
// const jsBase38SimdD = encodeBase38(hash);
// console.log(jsEncode(hash), jsEncode(hash.subarray(0, 32)));
// console.log(jsBase38SimdD, jsBase38);
