import { getFinalDirectory, getPrefixPath, getShortPrefixPath } from '#viat/storage/getPrefixPath';
import {
	getWalletPath,
	getWalletURL,
	walletPathToURL,
...
export function getTransactionHashFilename(transactionHash) {
...
console.log('getTransactionFilename', getTransactionFilename(txBufferex), getTransactionFilename(txBufferex).length);
