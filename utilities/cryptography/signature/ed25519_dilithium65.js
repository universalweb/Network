...
export const ed25519Dilithium65 = signatureScheme({
...
// console.log(key);
// const exported = await ed25519Dilithium65.exportKeypair(key);
// console.log('exported', exported);
// const bexport = await ed25519Dilithium65.exportBinary(exported);
// console.log('Binary Export', bexport, bexport.length);
// const bimport = await ed25519Dilithium65.initializeBinary(bexport);
// console.log('Binary Import', bimport);
// const msg = Buffer.from('hello world');
// console.log(exported.publicKey.length, exported.privateKey.length);
// const sig = await ed25519Dilithium65.sign(msg, key);
// console.log('signature', sig.length, await decode(sig));
// console.log(await ed25519Dilithium65.verify(sig, msg, key));
// const imported = await ed25519Dilithium65.initializeKeypair(exported);
// console.log('imported', imported);
// console.log(await ed25519Dilithium65.verify(sig, msg, imported));
// const sig2 = await ed25519Dilithium65.sign(msg, imported);
// console.log('sig2', sig2.length, await decode(sig2));
// console.log(await ed25519Dilithium65.verifyPartial(sig, msg, imported));
