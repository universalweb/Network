...
export async function sign(message, privateKeyArg) {
	...
	const dilithiumSignature = await dilithium65.sign(message, dilithiumPrivateKey);
...
export async function verifySignature(signature, message, publicKey) {
	...
	const dilithiumVerify = await dilithium65.verifySignature(dilithiumSignature, dilithiumPublicKey, message);
...
export async function signatureKeypair(target) {
	...
	const dilithiumNewKeypair =	await dilithium65.signatureKeypair();
...
export const dilithium65_ed25519 = {
	name: 'dilithium65_ed25519',
	alias: 'dilithium65_ed25519',
	ed25519,
	dilithium65,
	id: 1,
	verifySignature,
...
export default dilithium65_ed25519;
