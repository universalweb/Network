module.exports = async (state) => {
	...
	const resourcesDirectory = path.normalize(`${__dirname}/../../resources/`);
	console.log(resourcesDirectory);
	const resourceWhiteList = ['css/index.css', 'css/uikit-rtl.css', 'css/uikit-rtl.css', 'css/uikit.css', 'images/logo.png', 'js/msgPack.js', 'js/ractive.js', 'js/components.js', 'js/uikit.js', 'js/uikitIcons.js', 'js/utility.js'];
