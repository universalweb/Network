...
import viat from '../cryptoMiddleware/cipherSuite/viat.js';
export class Profile {
	...
	verifySignaturePartial(signature, message) {
		return this.cipherSuite.signature.verifySignaturePartial(signature, message, this.signatureKeypair);
	}
...
// console.log(await exampleProfileExample.verifySignaturePartial(sig, messageExample));
// const sigPartial = await exampleProfileExample.signPartial(messageExample);
// console.log(sigPartial);
// console.log(await exampleProfileExample.verifySignaturePartial(sigPartial, messageExample));
